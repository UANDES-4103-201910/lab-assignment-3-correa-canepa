...
User.create(name:"Matias",last_name:"Canepa", email:"macanepa@miuandes.cl",phone:"+56 9 92781334", password:"wiwi",address:"Camino Las Hualtatas")
...
Event.create(name:"Recital",description:"Papurri Papa", start_date:"06/01/2019",venue_id:1)
...
Ticket.create(price:1100, category_id:1, event_id:2, order_id:1)
Ticket.create(price:1100, category_id:1, event_id:2, order_id:2)
Ticket.create(price:1100, category_id:1, event_id:2, order_id:3)
